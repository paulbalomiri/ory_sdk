...
public class V0alpha2Api {
    ...
    /**
     * Build call for adminGetSession
     * @param id ID is the session&#39;s ID. (required)
     ...
     */
    public okhttp3.Call adminGetSessionCall(String id, List<String> expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminGetSessionValidateBeforeCall(String id, List<String> expand, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling adminGetSession(Async)");
        }
        

        okhttp3.Call localVarCall = adminGetSessionCall(id, expand, _callback);
        return localVarCall;
     ...
     */
    public Session adminGetSession(String id, List<String> expand) throws ApiException {
        ApiResponse<Session> localVarResp = adminGetSessionWithHttpInfo(id, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Session> adminGetSessionWithHttpInfo(String id, List<String> expand) throws ApiException {
        okhttp3.Call localVarCall = adminGetSessionValidateBeforeCall(id, expand, null);
        Type localVarReturnType = new TypeToken<Session>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call adminGetSessionAsync(String id, List<String> expand, final ApiCallback<Session> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminGetSessionValidateBeforeCall(id, expand, _callback);
        Type localVarReturnType = new TypeToken<Session>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for adminListSessions
     ...
     */
    public okhttp3.Call adminListSessionsCall(Long pageSize, String pageToken, Boolean active, List<String> expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminListSessionsValidateBeforeCall(Long pageSize, String pageToken, Boolean active, List<String> expand, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = adminListSessionsCall(pageSize, pageToken, active, expand, _callback);
        return localVarCall;
     ...
     */
    public List<Session> adminListSessions(Long pageSize, String pageToken, Boolean active, List<String> expand) throws ApiException {
        ApiResponse<List<Session>> localVarResp = adminListSessionsWithHttpInfo(pageSize, pageToken, active, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Session>> adminListSessionsWithHttpInfo(Long pageSize, String pageToken, Boolean active, List<String> expand) throws ApiException {
        okhttp3.Call localVarCall = adminListSessionsValidateBeforeCall(pageSize, pageToken, active, expand, null);
        Type localVarReturnType = new TypeToken<List<Session>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * This endpoint returns all sessions that exist. (asynchronously)
     * This endpoint is useful for:  Listing all sessions that exist in an administrative context.
     * @param pageSize Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to 250)
     * @param pageToken Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional)
     * @param active Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned. (optional)
     ...
     */
    public okhttp3.Call adminListSessionsAsync(Long pageSize, String pageToken, Boolean active, List<String> expand, final ApiCallback<List<Session>> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminListSessionsValidateBeforeCall(pageSize, pageToken, active, expand, _callback);
        Type localVarReturnType = new TypeToken<List<Session>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginFlowForBrowsersCall(Boolean refresh, String aal, String returnTo, String cookie, String loginChallenge, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(Boolean refresh, String aal, String returnTo, String cookie, String loginChallenge, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersCall(refresh, aal, returnTo, cookie, loginChallenge, _callback);
        return localVarCall;
     ...
     */
    public SelfServiceLoginFlow initializeSelfServiceLoginFlowForBrowsers(Boolean refresh, String aal, String returnTo, String cookie, String loginChallenge) throws ApiException {
        ApiResponse<SelfServiceLoginFlow> localVarResp = initializeSelfServiceLoginFlowForBrowsersWithHttpInfo(refresh, aal, returnTo, cookie, loginChallenge);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SelfServiceLoginFlow> initializeSelfServiceLoginFlowForBrowsersWithHttpInfo(Boolean refresh, String aal, String returnTo, String cookie, String loginChallenge) throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(refresh, aal, returnTo, cookie, loginChallenge, null);
        Type localVarReturnType = new TypeToken<SelfServiceLoginFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginFlowForBrowsersAsync(Boolean refresh, String aal, String returnTo, String cookie, String loginChallenge, final ApiCallback<SelfServiceLoginFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(refresh, aal, returnTo, cookie, loginChallenge, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceLoginFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceRegistrationFlowForBrowsersCall(String returnTo, String loginChallenge, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceRegistrationFlowForBrowsersValidateBeforeCall(String returnTo, String loginChallenge, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceRegistrationFlowForBrowsersCall(returnTo, loginChallenge, _callback);
        return localVarCall;
     ...
     */
    public SelfServiceRegistrationFlow initializeSelfServiceRegistrationFlowForBrowsers(String returnTo, String loginChallenge) throws ApiException {
        ApiResponse<SelfServiceRegistrationFlow> localVarResp = initializeSelfServiceRegistrationFlowForBrowsersWithHttpInfo(returnTo, loginChallenge);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SelfServiceRegistrationFlow> initializeSelfServiceRegistrationFlowForBrowsersWithHttpInfo(String returnTo, String loginChallenge) throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceRegistrationFlowForBrowsersValidateBeforeCall(returnTo, loginChallenge, null);
        Type localVarReturnType = new TypeToken<SelfServiceRegistrationFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceRegistrationFlowForBrowsersAsync(String returnTo, String loginChallenge, final ApiCallback<SelfServiceRegistrationFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceRegistrationFlowForBrowsersValidateBeforeCall(returnTo, loginChallenge, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceRegistrationFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Invalidate all Other Sessions (asynchronously)
     * Calling this endpoint invalidates all except the current session that belong to the logged-in user. Session data are not deleted.  This endpoint is useful for:  To forcefully logout the current user from all other devices and sessions
     * @param xSessionToken Set the Session Token when calling from non-browser clients. A session token has a format of &#x60;MP2YWEMeM8MxjkGKpH4dqOQ4Q4DlSPaj&#x60;. (optional)
     * @param cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored. (optional)
     * @param _callback The callback to be executed when the API call finishes
