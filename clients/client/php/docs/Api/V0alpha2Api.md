...
```php
adminGetSession($id, $expand): \Ory\Client\Model\Session
```
...
try {
    $result = $apiInstance->adminGetSession($id, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling V0alpha2Api->adminGetSession: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
adminListSessions($pageSize, $pageToken, $active, $expand): \Ory\Client\Model\Session[]
```
...
try {
    $result = $apiInstance->adminListSessions($pageSize, $pageToken, $active, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling V0alpha2Api->adminListSessions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
initializeSelfServiceLoginFlowForBrowsers($refresh, $aal, $returnTo, $cookie, $loginChallenge): \Ory\Client\Model\SelfServiceLoginFlow
```
...
try {
    $result = $apiInstance->initializeSelfServiceLoginFlowForBrowsers($refresh, $aal, $returnTo, $cookie, $loginChallenge);
    print_r($result);
} catch (Exception $e) {
...
```php
initializeSelfServiceRegistrationFlowForBrowsers($returnTo, $loginChallenge): \Ory\Client\Model\SelfServiceRegistrationFlow
```
...
try {
    $result = $apiInstance->initializeSelfServiceRegistrationFlowForBrowsers($returnTo, $loginChallenge);
    print_r($result);
} catch (Exception $e) {
