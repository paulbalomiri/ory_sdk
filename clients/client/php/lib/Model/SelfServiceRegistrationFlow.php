...
class SelfServiceRegistrationFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'oauth2LoginRequest' => '\Ory\Client\Model\LoginRequest',
        'requestUrl' => 'string',
        'returnTo' => 'string',
        'type' => 'string',
     ...
     *
     * @return \Ory\Client\Model\LoginRequest|null
     */
     ...
     *
     * @param \Ory\Client\Model\LoginRequest|null $oauth2LoginRequest oauth2LoginRequest
     *
     * @return self
     */
