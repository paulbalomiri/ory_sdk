...
class V0alpha2Api
{
    ...
    /**
     * Operation adminCreateSelfServiceRecoveryCode
     *
     * Create a Recovery Code
     *
     * @param  \Ory\Client\Model\AdminCreateSelfServiceRecoveryCodeBody $adminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody (optional)
     *
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SelfServiceRecoveryCode|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError
     */
    public function adminCreateSelfServiceRecoveryCode($adminCreateSelfServiceRecoveryCodeBody = null)
    {
        list($response) = $this->adminCreateSelfServiceRecoveryCodeWithHttpInfo($adminCreateSelfServiceRecoveryCodeBody);
        return $response;
    }

    /**
     * Operation adminCreateSelfServiceRecoveryCodeWithHttpInfo
     *
     * Create a Recovery Code
     *
     * @param  \Ory\Client\Model\AdminCreateSelfServiceRecoveryCodeBody $adminCreateSelfServiceRecoveryCodeBody (optional)
     *
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SelfServiceRecoveryCode|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminCreateSelfServiceRecoveryCodeWithHttpInfo($adminCreateSelfServiceRecoveryCodeBody = null)
    {
        $request = $this->adminCreateSelfServiceRecoveryCodeRequest($adminCreateSelfServiceRecoveryCodeBody);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Ory\Client\Model\SelfServiceRecoveryCode' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Client\Model\SelfServiceRecoveryCode', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ory\Client\Model\SelfServiceRecoveryCode';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Client\Model\SelfServiceRecoveryCode',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation adminCreateSelfServiceRecoveryCodeAsync
     *
     * Create a Recovery Code
     *
     * @param  \Ory\Client\Model\AdminCreateSelfServiceRecoveryCodeBody $adminCreateSelfServiceRecoveryCodeBody (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminCreateSelfServiceRecoveryCodeAsync($adminCreateSelfServiceRecoveryCodeBody = null)
    {
        return $this->adminCreateSelfServiceRecoveryCodeAsyncWithHttpInfo($adminCreateSelfServiceRecoveryCodeBody)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminCreateSelfServiceRecoveryCodeAsyncWithHttpInfo
     *
     * Create a Recovery Code
     *
     * @param  \Ory\Client\Model\AdminCreateSelfServiceRecoveryCodeBody $adminCreateSelfServiceRecoveryCodeBody (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminCreateSelfServiceRecoveryCodeAsyncWithHttpInfo($adminCreateSelfServiceRecoveryCodeBody = null)
    {
        $returnType = '\Ory\Client\Model\SelfServiceRecoveryCode';
        $request = $this->adminCreateSelfServiceRecoveryCodeRequest($adminCreateSelfServiceRecoveryCodeBody);
    ...
    /**
     * Create request for operation 'adminCreateSelfServiceRecoveryCode'
     *
     * @param  \Ory\Client\Model\AdminCreateSelfServiceRecoveryCodeBody $adminCreateSelfServiceRecoveryCodeBody (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminCreateSelfServiceRecoveryCodeRequest($adminCreateSelfServiceRecoveryCodeBody = null)
    {
        ...
        // for model (json/xml)
        if (isset($adminCreateSelfServiceRecoveryCodeBody)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($adminCreateSelfServiceRecoveryCodeBody));
            } else {
                $httpBody = $adminCreateSelfServiceRecoveryCodeBody;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     */
    public function adminGetSession($id, $expand = null)
    {
        list($response) = $this->adminGetSessionWithHttpInfo($id, $expand);
        return $response;
    }

    /**
     * Operation adminGetSessionWithHttpInfo
     *
     * This endpoint returns the session object with expandables specified.
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     */
    public function adminGetSessionWithHttpInfo($id, $expand = null)
    {
        $request = $this->adminGetSessionRequest($id, $expand);
    ...
    /**
     * Operation adminGetSessionAsync
     *
     * This endpoint returns the session object with expandables specified.
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminGetSessionAsync($id, $expand = null)
    {
        return $this->adminGetSessionAsyncWithHttpInfo($id, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminGetSessionAsyncWithHttpInfo
     *
     * This endpoint returns the session object with expandables specified.
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminGetSessionAsyncWithHttpInfo($id, $expand = null)
    {
        $returnType = '\Ory\Client\Model\Session';
        $request = $this->adminGetSessionRequest($id, $expand);
    ...
    /**
     * Create request for operation 'adminGetSession'
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     * @param  string[] $expand ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. Example - ?expand&#x3D;Identity&amp;expand&#x3D;Devices If no value is provided, the expandable properties are skipped. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminGetSessionRequest($id, $expand = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling adminGetSession'
            );
        }
    ...
    /**
     * Operation adminListCourierMessages
     *
     * List Messages
     *
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\Message[]|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError
     */
    public function adminListCourierMessages($perPage = 250, $page = 1, $status = null, $recipient = null)
    {
        list($response) = $this->adminListCourierMessagesWithHttpInfo($perPage, $page, $status, $recipient);
        return $response;
    }

    /**
     * Operation adminListCourierMessagesWithHttpInfo
     *
     * List Messages
     *
     * @param  int $perPage Items per Page  This is the number of items per page. (optional, default to 250)
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\Message[]|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminListCourierMessagesWithHttpInfo($perPage = 250, $page = 1, $status = null, $recipient = null)
    {
        $request = $this->adminListCourierMessagesRequest($perPage, $page, $status, $recipient);
    ...
    /**
     * Operation adminListCourierMessagesAsync
     *
     * List Messages
     *
     * @param  int $perPage Items per Page  This is the number of items per page. (optional, default to 250)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminListCourierMessagesAsync($perPage = 250, $page = 1, $status = null, $recipient = null)
    {
        return $this->adminListCourierMessagesAsyncWithHttpInfo($perPage, $page, $status, $recipient)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminListCourierMessagesAsyncWithHttpInfo
     *
     * List Messages
     *
     * @param  int $perPage Items per Page  This is the number of items per page. (optional, default to 250)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminListCourierMessagesAsyncWithHttpInfo($perPage = 250, $page = 1, $status = null, $recipient = null)
    {
        $returnType = '\Ory\Client\Model\Message[]';
        $request = $this->adminListCourierMessagesRequest($perPage, $page, $status, $recipient);
    ...
    /**
     * Create request for operation 'adminListCourierMessages'
     *
     * @param  int $perPage Items per Page  This is the number of items per page. (optional, default to 250)
     * @param  int $page Pagination Page  This value is currently an integer, but it is not sequential. The value is not the page number, but a reference. The next page can be any number and some numbers might return an empty list.  For example, page 2 might not follow after page 1. And even if page 3 and 5 exist, but page 4 might not exist. (optional, default to 1)
     * @param  \Ory\Client\Model\CourierMessageStatus $status Status filters out messages based on status. If no value is provided, it doesn&#39;t take effect on filter. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminListCourierMessagesRequest($perPage = 250, $page = 1, $status = null, $recipient = null)
    {
        if ($perPage !== null && $perPage > 1000) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling V0alpha2Api.adminListCourierMessages, must be smaller than or equal to 1000.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling V0alpha2Api.adminListCourierMessages, must be bigger than or equal to 1.');
        }

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling V0alpha2Api.adminListCourierMessages, must be bigger than or equal to 1.');
        }
     ...
     * @return \Ory\Client\Model\Session[]|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError
     */
    public function adminListSessions($pageSize = 250, $pageToken = null, $active = null, $expand = null)
    {
        list($response) = $this->adminListSessionsWithHttpInfo($pageSize, $pageToken, $active, $expand);
        return $response;
    }

    /**
     * Operation adminListSessionsWithHttpInfo
     *
     * This endpoint returns all sessions that exist.
     *
     * @param  int $pageSize Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to 250)
     ...
     * @return array of \Ory\Client\Model\Session[]|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminListSessionsWithHttpInfo($pageSize = 250, $pageToken = null, $active = null, $expand = null)
    {
        $request = $this->adminListSessionsRequest($pageSize, $pageToken, $active, $expand);
    ...
    /**
     * Operation adminListSessionsAsync
     *
     * This endpoint returns all sessions that exist.
     *
     * @param  int $pageSize Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to 250)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminListSessionsAsync($pageSize = 250, $pageToken = null, $active = null, $expand = null)
    {
        return $this->adminListSessionsAsyncWithHttpInfo($pageSize, $pageToken, $active, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminListSessionsAsyncWithHttpInfo
     *
     * This endpoint returns all sessions that exist.
     *
     * @param  int $pageSize Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to 250)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminListSessionsAsyncWithHttpInfo($pageSize = 250, $pageToken = null, $active = null, $expand = null)
    {
        $returnType = '\Ory\Client\Model\Session[]';
        $request = $this->adminListSessionsRequest($pageSize, $pageToken, $active, $expand);
    ...
    /**
     * Create request for operation 'adminListSessions'
     *
     * @param  int $pageSize Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to 250)
     * @param  string $pageToken Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional)
     * @param  bool $active Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminListSessionsRequest($pageSize = 250, $pageToken = null, $active = null, $expand = null)
    {
        if ($pageSize !== null && $pageSize > 1000) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling V0alpha2Api.adminListSessions, must be smaller than or equal to 1000.');
        }
        if ($pageSize !== null && $pageSize < 1) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling V0alpha2Api.adminListSessions, must be bigger than or equal to 1.');
        }
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\ProjectApiKey|\Ory\Client\Model\GenericError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\ProjectApiKey|\Ory\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function initializeSelfServiceLoginFlowForBrowsers($refresh = null, $aal = null, $returnTo = null, $cookie = null, $loginChallenge = null)
    {
        list($response) = $this->initializeSelfServiceLoginFlowForBrowsersWithHttpInfo($refresh, $aal, $returnTo, $cookie, $loginChallenge);
        return $response;
    }
     ...
     */
    public function initializeSelfServiceLoginFlowForBrowsersWithHttpInfo($refresh = null, $aal = null, $returnTo = null, $cookie = null, $loginChallenge = null)
    {
        $request = $this->initializeSelfServiceLoginFlowForBrowsersRequest($refresh, $aal, $returnTo, $cookie, $loginChallenge);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceLoginFlowForBrowsersAsync($refresh = null, $aal = null, $returnTo = null, $cookie = null, $loginChallenge = null)
    {
        return $this->initializeSelfServiceLoginFlowForBrowsersAsyncWithHttpInfo($refresh, $aal, $returnTo, $cookie, $loginChallenge)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceLoginFlowForBrowsersAsyncWithHttpInfo($refresh = null, $aal = null, $returnTo = null, $cookie = null, $loginChallenge = null)
    {
        $returnType = '\Ory\Client\Model\SelfServiceLoginFlow';
        $request = $this->initializeSelfServiceLoginFlowForBrowsersRequest($refresh, $aal, $returnTo, $cookie, $loginChallenge);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function initializeSelfServiceLoginFlowForBrowsersRequest($refresh = null, $aal = null, $returnTo = null, $cookie = null, $loginChallenge = null)
    {
     ...
     */
    public function initializeSelfServiceRegistrationFlowForBrowsers($returnTo = null, $loginChallenge = null)
    {
        list($response) = $this->initializeSelfServiceRegistrationFlowForBrowsersWithHttpInfo($returnTo, $loginChallenge);
        return $response;
    }
     ...
     */
    public function initializeSelfServiceRegistrationFlowForBrowsersWithHttpInfo($returnTo = null, $loginChallenge = null)
    {
        $request = $this->initializeSelfServiceRegistrationFlowForBrowsersRequest($returnTo, $loginChallenge);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceRegistrationFlowForBrowsersAsync($returnTo = null, $loginChallenge = null)
    {
        return $this->initializeSelfServiceRegistrationFlowForBrowsersAsyncWithHttpInfo($returnTo, $loginChallenge)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceRegistrationFlowForBrowsersAsyncWithHttpInfo($returnTo = null, $loginChallenge = null)
    {
        $returnType = '\Ory\Client\Model\SelfServiceRegistrationFlow';
        $request = $this->initializeSelfServiceRegistrationFlowForBrowsersRequest($returnTo, $loginChallenge);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function initializeSelfServiceRegistrationFlowForBrowsersRequest($returnTo = null, $loginChallenge = null)
    {
     ...
     */
    public function initializeSelfServiceSettingsFlowForBrowsers($returnTo = null, $cookie = null)
    {
        list($response) = $this->initializeSelfServiceSettingsFlowForBrowsersWithHttpInfo($returnTo, $cookie);
        return $response;
    }
     ...
     */
    public function initializeSelfServiceSettingsFlowForBrowsersWithHttpInfo($returnTo = null, $cookie = null)
    {
        $request = $this->initializeSelfServiceSettingsFlowForBrowsersRequest($returnTo, $cookie);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceSettingsFlowForBrowsersAsync($returnTo = null, $cookie = null)
    {
        return $this->initializeSelfServiceSettingsFlowForBrowsersAsyncWithHttpInfo($returnTo, $cookie)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeSelfServiceSettingsFlowForBrowsersAsyncWithHttpInfo($returnTo = null, $cookie = null)
    {
        $returnType = '\Ory\Client\Model\SelfServiceSettingsFlow';
        $request = $this->initializeSelfServiceSettingsFlowForBrowsersRequest($returnTo, $cookie);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function initializeSelfServiceSettingsFlowForBrowsersRequest($returnTo = null, $cookie = null)
    {
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SelfServiceRecoveryFlow|\Ory\Client\Model\SelfServiceRecoveryFlow|\Ory\Client\Model\JsonError|\Ory\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SelfServiceRecoveryFlow|\Ory\Client\Model\SelfServiceRecoveryFlow|\Ory\Client\Model\JsonError|\Ory\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
