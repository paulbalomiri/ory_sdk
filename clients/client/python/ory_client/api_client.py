...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IdentityApi()
        api_instance.disable_session  # this is an instance of the class Endpoint
        api_instance.disable_session()  # this invokes api_instance.disable_session.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.disable_session.callable or self.callable in this class
