...
abstract class OpenIDConnectContext implements Built<OpenIDConnectContext, OpenIDConnectContextBuilder> {
  ...
  static void _defaults(OpenIDConnectContextBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OpenIDConnectContext> get serializer => _$OpenIDConnectContextSerializer();
}

class _$OpenIDConnectContextSerializer implements PrimitiveSerializer<OpenIDConnectContext> {
  @override
  ...
  void _deserializeProperties(
    ...
    required OpenIDConnectContextBuilder result,
  ...
  @override
  OpenIDConnectContext deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
