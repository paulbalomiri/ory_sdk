...
final api = OryClient().getV0alpha2Api();
final AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody = ; // AdminCreateSelfServiceRecoveryCodeBody | 

try {
    final response = api.adminCreateSelfServiceRecoveryCode(adminCreateSelfServiceRecoveryCodeBody);
    print(response);
} catch on DioError (e) {
    print('Exception when calling V0alpha2Api->adminCreateSelfServiceRecoveryCode: $e\n');
}
```
...
try {
    final response = api.adminExtendSession(id);
    print(response);
} catch on DioError (e) {
...
> BuiltList<Message> adminListCourierMessages(perPage, page, status, recipient)
...
try {
    final response = api.adminListCourierMessages(perPage, page, status, recipient);
    print(response);
} catch on DioError (e) {
    print('Exception when calling V0alpha2Api->adminListCourierMessages: $e\n');
}
```
...
try {
    final response = api.adminListIdentitySessions(id, perPage, page, active);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.adminPatchIdentity(id, jsonPatch);
    print(response);
} catch on DioError (e) {
...
try {
    ...
    print('Exception when calling V0alpha2Api->createProjectApiKey: $e\n');
}
```
...
try {
    ...
    print('Exception when calling V0alpha2Api->deleteProjectApiKey: $e\n');
}
```
...
try {
    final response = api.initializeSelfServiceSettingsFlowForBrowsers(returnTo, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    ...
    print('Exception when calling V0alpha2Api->listProjectApiKeys: $e\n');
}
```
...
try {
    final response = api.listSessions(xSessionToken, cookie, perPage, page);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.revokeSessions(xSessionToken, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.submitSelfServiceLoginFlow(flow, submitSelfServiceLoginFlowBody, xSessionToken, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.submitSelfServiceRecoveryFlow(flow, submitSelfServiceRecoveryFlowBody, token, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.submitSelfServiceRegistrationFlow(flow, submitSelfServiceRegistrationFlowBody, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.submitSelfServiceSettingsFlow(flow, submitSelfServiceSettingsFlowBody, xSessionToken, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.submitSelfServiceVerificationFlow(flow, submitSelfServiceVerificationFlowBody, token, cookie);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.updateProject(projectId, updateProject);
    print(response);
} catch on DioError (e) {
