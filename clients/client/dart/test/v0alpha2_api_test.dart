...
void main() {
  ...
  group(V0alpha2Api, () {
    ...
    //
    //Future<Session> adminGetSession(String id, { BuiltList<String> expand }) async
    test('test adminGetSession', () async {
      // TODO
    });
    ...
    //
    //Future<BuiltList<Session>> adminListSessions({ int pageSize, String pageToken, bool active, BuiltList<String> expand }) async
    test('test adminListSessions', () async {
      // TODO
    });
    ...
    //
    //Future<SelfServiceLoginFlow> initializeSelfServiceLoginFlowForBrowsers({ bool refresh, String aal, String returnTo, String cookie, String loginChallenge }) async
    ...
    //
    //Future<SelfServiceRegistrationFlow> initializeSelfServiceRegistrationFlowForBrowsers({ String returnTo, String loginChallenge }) async
