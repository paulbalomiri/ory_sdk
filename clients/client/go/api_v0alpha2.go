...
(or activate) their account.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest
	*/
	AdminCreateSelfServiceRecoveryCode(ctx context.Context) V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest

	// AdminCreateSelfServiceRecoveryCodeExecute executes the request
	//  @return SelfServiceRecoveryCode
	AdminCreateSelfServiceRecoveryCodeExecute(r V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest) (*SelfServiceRecoveryCode, *http.Response, error)
...
Getting a session object with all specified expandables that exist in an administrative context.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID is the session's ID.
	@return V0alpha2ApiAdminGetSessionRequest
	*/
	AdminGetSession(ctx context.Context, id string) V0alpha2ApiAdminGetSessionRequest

	// AdminGetSessionExecute executes the request
	//  @return Session
	AdminGetSessionExecute(r V0alpha2ApiAdminGetSessionRequest) (*Session, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return V0alpha2ApiAdminListCourierMessagesRequest
	*/
	AdminListCourierMessages(ctx context.Context) V0alpha2ApiAdminListCourierMessagesRequest

	// AdminListCourierMessagesExecute executes the request
	//  @return []Message
	AdminListCourierMessagesExecute(r V0alpha2ApiAdminListCourierMessagesRequest) ([]Message, *http.Response, error)
...
Listing all sessions that exist in an administrative context.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return V0alpha2ApiAdminListSessionsRequest
	*/
	AdminListSessions(ctx context.Context) V0alpha2ApiAdminListSessionsRequest

	// AdminListSessionsExecute executes the request
	//  @return []Session
	AdminListSessionsExecute(r V0alpha2ApiAdminListSessionsRequest) ([]Session, *http.Response, error)
...
type V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	adminCreateSelfServiceRecoveryCodeBody *AdminCreateSelfServiceRecoveryCodeBody
}

func (r V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest) AdminCreateSelfServiceRecoveryCodeBody(adminCreateSelfServiceRecoveryCodeBody AdminCreateSelfServiceRecoveryCodeBody) V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest {
	r.adminCreateSelfServiceRecoveryCodeBody = &adminCreateSelfServiceRecoveryCodeBody
	return r
}

func (r V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest) Execute() (*SelfServiceRecoveryCode, *http.Response, error) {
...
(or activate) their account.
 ...
 @return V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest
*/
func (a *V0alpha2ApiService) AdminCreateSelfServiceRecoveryCode(ctx context.Context) V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest {
	return V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SelfServiceRecoveryCode
func (a *V0alpha2ApiService) AdminCreateSelfServiceRecoveryCodeExecute(r V0alpha2ApiAdminCreateSelfServiceRecoveryCodeRequest) (*SelfServiceRecoveryCode, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type V0alpha2ApiAdminGetSessionRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	id string
	expand *[]string
...
func (r V0alpha2ApiAdminGetSessionRequest) Expand(expand []string) V0alpha2ApiAdminGetSessionRequest {
	r.expand = &expand
	return r
}

func (r V0alpha2ApiAdminGetSessionRequest) Execute() (*Session, *http.Response, error) {
...
Getting a session object with all specified expandables that exist in an administrative context.
 ...
 @return V0alpha2ApiAdminGetSessionRequest
*/
func (a *V0alpha2ApiService) AdminGetSession(ctx context.Context, id string) V0alpha2ApiAdminGetSessionRequest {
	return V0alpha2ApiAdminGetSessionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Session
func (a *V0alpha2ApiService) AdminGetSessionExecute(r V0alpha2ApiAdminGetSessionRequest) (*Session, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type V0alpha2ApiAdminListCourierMessagesRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	perPage *int64
	page *int64
...
func (r V0alpha2ApiAdminListCourierMessagesRequest) PerPage(perPage int64) V0alpha2ApiAdminListCourierMessagesRequest {
	r.perPage = &perPage
	return r
}

// Pagination Page  This value is currently an integer, but it is not sequential. The value is not the page number, but a reference. The next page can be any number and some numbers might return an empty list.  For example, page 2 might not follow after page 1. And even if page 3 and 5 exist, but page 4 might not exist.
func (r V0alpha2ApiAdminListCourierMessagesRequest) Page(page int64) V0alpha2ApiAdminListCourierMessagesRequest {
	r.page = &page
	return r
}

// Status filters out messages based on status. If no value is provided, it doesn&#39;t take effect on filter.
func (r V0alpha2ApiAdminListCourierMessagesRequest) Status(status CourierMessageStatus) V0alpha2ApiAdminListCourierMessagesRequest {
	r.status = &status
	return r
}

// Recipient filters out messages based on recipient. If no value is provided, it doesn&#39;t take effect on filter.
func (r V0alpha2ApiAdminListCourierMessagesRequest) Recipient(recipient string) V0alpha2ApiAdminListCourierMessagesRequest {
	r.recipient = &recipient
	return r
}

func (r V0alpha2ApiAdminListCourierMessagesRequest) Execute() ([]Message, *http.Response, error) {
...
Lists all messages by given status and recipient.
 ...
 @return V0alpha2ApiAdminListCourierMessagesRequest
*/
func (a *V0alpha2ApiService) AdminListCourierMessages(ctx context.Context) V0alpha2ApiAdminListCourierMessagesRequest {
	return V0alpha2ApiAdminListCourierMessagesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Message
func (a *V0alpha2ApiService) AdminListCourierMessagesExecute(r V0alpha2ApiAdminListCourierMessagesRequest) ([]Message, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type V0alpha2ApiAdminListSessionsRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	pageSize *int64
	pageToken *string
...
func (r V0alpha2ApiAdminListSessionsRequest) PageSize(pageSize int64) V0alpha2ApiAdminListSessionsRequest {
	r.pageSize = &pageSize
	return r
}

// Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination).
func (r V0alpha2ApiAdminListSessionsRequest) PageToken(pageToken string) V0alpha2ApiAdminListSessionsRequest {
	r.pageToken = &pageToken
	return r
}

// Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned.
func (r V0alpha2ApiAdminListSessionsRequest) Active(active bool) V0alpha2ApiAdminListSessionsRequest {
	r.active = &active
	return r
}

// ExpandOptions is a query parameter encoded list of all properties that must be expanded in the Session. Example - ?expand&#x3D;Identity&amp;expand&#x3D;Devices If no value is provided, the expandable properties are skipped.
func (r V0alpha2ApiAdminListSessionsRequest) Expand(expand []string) V0alpha2ApiAdminListSessionsRequest {
	r.expand = &expand
	return r
}

func (r V0alpha2ApiAdminListSessionsRequest) Execute() ([]Session, *http.Response, error) {
...
Listing all sessions that exist in an administrative context.
 ...
 @return V0alpha2ApiAdminListSessionsRequest
*/
func (a *V0alpha2ApiService) AdminListSessions(ctx context.Context) V0alpha2ApiAdminListSessionsRequest {
	return V0alpha2ApiAdminListSessionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Session
func (a *V0alpha2ApiService) AdminListSessionsExecute(r V0alpha2ApiAdminListSessionsRequest) ([]Session, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
func (r V0alpha2ApiInitializeSelfServiceLoginFlowForBrowsersRequest) Cookie(cookie string) V0alpha2ApiInitializeSelfServiceLoginFlowForBrowsersRequest {
	r.cookie = &cookie
	return r
}
...
func (r V0alpha2ApiInitializeSelfServiceLoginFlowForBrowsersRequest) LoginChallenge(loginChallenge string) V0alpha2ApiInitializeSelfServiceLoginFlowForBrowsersRequest {
...
func (r V0alpha2ApiInitializeSelfServiceRegistrationFlowForBrowsersRequest) LoginChallenge(loginChallenge string) V0alpha2ApiInitializeSelfServiceRegistrationFlowForBrowsersRequest {
	r.loginChallenge = &loginChallenge
	return r
}
...
// HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
func (r V0alpha2ApiInitializeSelfServiceSettingsFlowForBrowsersRequest) Cookie(cookie string) V0alpha2ApiInitializeSelfServiceSettingsFlowForBrowsersRequest {
	r.cookie = &cookie
	return r
}
