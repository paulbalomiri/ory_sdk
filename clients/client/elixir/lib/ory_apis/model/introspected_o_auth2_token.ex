...
defmodule OryAPIs.Model.IntrospectedOAuth2Token do
  @moduledoc """
...
defimpl Poison.Decoder, for: OryAPIs.Model.IntrospectedOAuth2Token do
  import OryAPIs.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:ext, :map, OryAPIs.Model.AnyType, options)
  end
end
