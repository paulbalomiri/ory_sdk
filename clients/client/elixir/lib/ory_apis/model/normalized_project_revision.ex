...
defmodule OryAPIs.Model.NormalizedProjectRevision do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :keto_namespaces => [OryAPIs.Model.KetoNamespace.t] | nil,
    ...
    :kratos_identity_schemas => [OryAPIs.Model.NormalizedProjectRevisionIdentitySchema.t] | nil,
    ...
    :kratos_selfservice_flows_hooks => [OryAPIs.Model.NormalizedProjectRevisionHook.t] | nil,
    ...
    :kratos_selfservice_methods_oidc_config_providers => [OryAPIs.Model.NormalizedProjectRevisionThirdPartyProvider.t] | nil,
...
defimpl Poison.Decoder, for: OryAPIs.Model.NormalizedProjectRevision do
  import OryAPIs.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:hydra_strategies_access_token, :struct, OryAPIs.Model.AnyType, options)
    |> deserialize(:hydra_strategies_scope, :struct, OryAPIs.Model.AnyType, options)
    |> deserialize(:keto_namespaces, :list, OryAPIs.Model.KetoNamespace, options)
    |> deserialize(:kratos_identity_schemas, :list, OryAPIs.Model.NormalizedProjectRevisionIdentitySchema, options)
    |> deserialize(:kratos_selfservice_flows_hooks, :list, OryAPIs.Model.NormalizedProjectRevisionHook, options)
    |> deserialize(:kratos_selfservice_methods_oidc_config_providers, :list, OryAPIs.Model.NormalizedProjectRevisionThirdPartyProvider, options)
  end
end
