...
defmodule OryAPIs.Model.NormalizedProjectRevisionThirdPartyProvider do
  @moduledoc """
...
defimpl Poison.Decoder, for: OryAPIs.Model.NormalizedProjectRevisionThirdPartyProvider do
