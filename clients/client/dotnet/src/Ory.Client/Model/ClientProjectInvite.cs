...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectInvite : IEquatable<ClientProjectInvite>, IValidatableObject
    {
        ...
        /// <param name="projectId">The Project&#39;s ID this invite is associated with (required).</param>
        ...
        public ClientProjectInvite(string inviteeEmail = default(string), string inviteeId = default(string), string ownerEmail = default(string), string ownerId = default(string), string projectId = default(string), string status = default(string))
        {
        ...
        /// </summary>
        /// <value>The Project&#39;s ID this invite is associated with</value>
