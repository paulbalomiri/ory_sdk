...
namespace Ory.Client.Model
{
    ...
    public partial class ClientPatchDelta : IEquatable<ClientPatchDelta>, IValidatableObject
    {
        ...
        public ClientPatchDelta(ActionEnum? action = default(ActionEnum?), ClientRelationTuple relationTuple = default(ClientRelationTuple))
        {
            this.Action = action;
        ...
        public ClientRelationTuple RelationTuple { get; set; }
