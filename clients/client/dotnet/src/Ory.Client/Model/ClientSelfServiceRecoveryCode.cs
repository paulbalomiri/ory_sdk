...
{
    /// <summary>
    /// ClientSelfServiceRecoveryCode
    /// </summary>
    [DataContract(Name = "selfServiceRecoveryCode")]
    public partial class ClientSelfServiceRecoveryCode : IEquatable<ClientSelfServiceRecoveryCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSelfServiceRecoveryCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSelfServiceRecoveryCode()
        {
        ...
        public ClientSelfServiceRecoveryCode(DateTime expiresAt = default(DateTime), string recoveryCode = default(string), string recoveryLink = default(string))
        {
            // to ensure "recoveryCode" is required (not null)
            if (recoveryCode == null) {
                throw new ArgumentNullException("recoveryCode is a required property for ClientSelfServiceRecoveryCode and cannot be null");
            }
            this.RecoveryCode = recoveryCode;
            // to ensure "recoveryLink" is required (not null)
            if (recoveryLink == null) {
                throw new ArgumentNullException("recoveryLink is a required property for ClientSelfServiceRecoveryCode and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSelfServiceRecoveryCode {\n");
        ...
        {
            return this.Equals(input as ClientSelfServiceRecoveryCode);
        }

        /// <summary>
        /// Returns true if ClientSelfServiceRecoveryCode instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSelfServiceRecoveryCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSelfServiceRecoveryCode input)
        {
            if (input == null)
            {
                return false;
