...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceRecoveryFlowBody : AbstractOpenAPISchema, IEquatable<ClientSubmitSelfServiceRecoveryFlowBody>, IValidatableObject
    {
        ...
        /// with the <see cref="ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody.</param>
        public ClientSubmitSelfServiceRecoveryFlowBody(ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody actualInstance)
        {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientSubmitSelfServiceRecoveryFlowWithLinkMethodBody))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody, ClientSubmitSelfServiceRecoveryFlowWithLinkMethodBody");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody`. If the actual instance is not `ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody</returns>
        public ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody GetClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody()
        {
            return (ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody)this.ActualInstance;
        }
        ...
        public static ClientSubmitSelfServiceRecoveryFlowBody FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                if (typeof(ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody).GetProperty("AdditionalProperties") == null)
                {
                    newClientSubmitSelfServiceRecoveryFlowBody = new ClientSubmitSelfServiceRecoveryFlowBody(JsonConvert.DeserializeObject<ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody>(jsonString, ClientSubmitSelfServiceRecoveryFlowBody.SerializerSettings));
                }
                else
                {
                    newClientSubmitSelfServiceRecoveryFlowBody = new ClientSubmitSelfServiceRecoveryFlowBody(JsonConvert.DeserializeObject<ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody>(jsonString, ClientSubmitSelfServiceRecoveryFlowBody.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody: {1}", jsonString, exception.ToString()));
            }
