...
namespace Ory.Client.Model
{
    ...
    public partial class ClientErrorAuthenticatorAssuranceLevelNotSatisfied : IEquatable<ClientErrorAuthenticatorAssuranceLevelNotSatisfied>, IValidatableObject
    {
        ...
        protected ClientErrorAuthenticatorAssuranceLevelNotSatisfied()
        {
        ...
        /// <param name="redirectBrowserTo">redirectBrowserTo.</param>
        ...
        public ClientErrorAuthenticatorAssuranceLevelNotSatisfied(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string id = default(string), string message = default(string), string reason = default(string), string redirectBrowserTo = default(string), string request = default(string), string status = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for ClientErrorAuthenticatorAssuranceLevelNotSatisfied and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets RedirectBrowserTo
        /// </summary>
