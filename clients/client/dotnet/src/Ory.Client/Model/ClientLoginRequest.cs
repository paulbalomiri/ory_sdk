...
namespace Ory.Client.Model
{
    ...
    public partial class ClientLoginRequest : IEquatable<ClientLoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientLoginRequest" /> class.
        /// </summary>
        ...
        public ClientLoginRequest(string challenge = default(string), ClientOAuth2Client _client = default(ClientOAuth2Client), ClientOpenIDConnectContext oidcContext = default(ClientOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), string sessionId = default(string), bool skip = default(bool), string subject = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientLoginRequest {\n");
        ...
        {
            return this.Equals(input as ClientLoginRequest);
        }

        /// <summary>
        /// Returns true if ClientLoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientLoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientLoginRequest input)
        {
            if (input == null)
            {
                return false;
