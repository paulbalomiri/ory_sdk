...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubscription : IEquatable<ClientSubscription>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The currently active plan of the subscription unknown Unknown free Free start_up_monthly StartUpMonthly start_up_yearly StartUpYearly business_monthly BusinessMonthly business_yearly BusinessYearly custom Custom</value>
        ...
        public ClientSubscription(string ongoingStripeCheckoutId = default(string), DateTime planChangesAt = default(DateTime), ClientNullPlan planChangesTo = default(ClientNullPlan), string status = default(string))
        {
