...
namespace Ory.Client.Model
{
    ...
    public partial class ClientAdminUpdateIdentityBody : IEquatable<ClientAdminUpdateIdentityBody>, IValidatableObject
    {
        ...
        public ClientAdminUpdateIdentityBody(ClientAdminIdentityImportCredentials credentials = default(ClientAdminIdentityImportCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), string schemaId = default(string), ClientIdentityState state = default(ClientIdentityState), Object traits = default(Object))
        {
            // to ensure "schemaId" is required (not null)
            if (schemaId == null) {
                throw new ArgumentNullException("schemaId is a required property for ClientAdminUpdateIdentityBody and cannot be null");
            }
