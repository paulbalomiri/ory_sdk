...
> ClientSelfServiceRecoveryCode AdminCreateSelfServiceRecoveryCode (ClientAdminCreateSelfServiceRecoveryCodeBody clientAdminCreateSelfServiceRecoveryCodeBody = null)
...
namespace Example
{
    public class AdminCreateSelfServiceRecoveryCodeExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new V0alpha2Api(config);
            var clientAdminCreateSelfServiceRecoveryCodeBody = new ClientAdminCreateSelfServiceRecoveryCodeBody(); // ClientAdminCreateSelfServiceRecoveryCodeBody |  (optional) 

            try
            {
                // Create a Recovery Code
                ClientSelfServiceRecoveryCode result = apiInstance.AdminCreateSelfServiceRecoveryCode(clientAdminCreateSelfServiceRecoveryCodeBody);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling V0alpha2Api.AdminCreateSelfServiceRecoveryCode: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **clientAdminCreateSelfServiceRecoveryCodeBody** | [**ClientAdminCreateSelfServiceRecoveryCodeBody**](ClientAdminCreateSelfServiceRecoveryCodeBody.md)|  | [optional] 

### Return type

[**ClientSelfServiceRecoveryCode**](ClientSelfServiceRecoveryCode.md)
...
<a name="admingetsession"></a>
# **AdminGetSession**
> ClientSession AdminGetSession (string id, List<string> expand = null)
...
namespace Example
{
    public class AdminGetSessionExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // This endpoint returns the session object with expandables specified.
                ClientSession result = apiInstance.AdminGetSession(id, expand);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling V0alpha2Api.AdminGetSession: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> List&lt;ClientMessage&gt; AdminListCourierMessages (long? perPage = null, long? page = null, ClientCourierMessageStatus? status = null, string recipient = null)
...
namespace Example
{
    public class AdminListCourierMessagesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // List Messages
                List<ClientMessage> result = apiInstance.AdminListCourierMessages(perPage, page, status, recipient);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling V0alpha2Api.AdminListCourierMessages: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a name="adminlistsessions"></a>
# **AdminListSessions**
> List&lt;ClientSession&gt; AdminListSessions (long? pageSize = null, string pageToken = null, bool? active = null, List<string> expand = null)
...
namespace Example
{
    public class AdminListSessionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // This endpoint returns all sessions that exist.
                List<ClientSession> result = apiInstance.AdminListSessions(pageSize, pageToken, active, expand);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling V0alpha2Api.AdminListSessions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class CreateProjectApiKeyExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V0alpha2Api.CreateProjectApiKey: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class DeleteProjectApiKeyExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V0alpha2Api.DeleteProjectApiKey: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> ClientSelfServiceLoginFlow InitializeSelfServiceLoginFlowForBrowsers (bool? refresh = null, string aal = null, string returnTo = null, string cookie = null, string loginChallenge = null)
...
namespace Example
{
    public class InitializeSelfServiceLoginFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Login Flow for Browsers
                ClientSelfServiceLoginFlow result = apiInstance.InitializeSelfServiceLoginFlowForBrowsers(refresh, aal, returnTo, cookie, loginChallenge);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSelfServiceRegistrationFlow InitializeSelfServiceRegistrationFlowForBrowsers (string returnTo = null, string loginChallenge = null)
...
namespace Example
{
    public class InitializeSelfServiceRegistrationFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Registration Flow for Browsers
                ClientSelfServiceRegistrationFlow result = apiInstance.InitializeSelfServiceRegistrationFlowForBrowsers(returnTo, loginChallenge);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSelfServiceSettingsFlow InitializeSelfServiceSettingsFlowForBrowsers (string returnTo = null, string cookie = null)
...
namespace Example
{
    public class InitializeSelfServiceSettingsFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Settings Flow for Browsers
                ClientSelfServiceSettingsFlow result = apiInstance.InitializeSelfServiceSettingsFlowForBrowsers(returnTo, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class ListProjectApiKeysExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V0alpha2Api.ListProjectApiKeys: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
