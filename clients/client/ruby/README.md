...
```shell
gem install ./ory-client-v0.3.0.gem
```

(for development, run `gem install --dev ./ory-client-v0.3.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-client', '~> v0.3.0'
...
begin
  ...
  puts "Exception when calling IdentityApi->disable_session: #{e}"
end
...
*OryClient::NamespacesApi* | [**get_namespaces**](docs/NamespacesApi.md#get_namespaces) | **GET** /namespaces | Query namespaces
...
*OryClient::OAuth2Api* | [**revoke_o_auth2_login_sessions**](docs/OAuth2Api.md#revoke_o_auth2_login_sessions) | **DELETE** /admin/oauth2/auth/sessions/login | Revokes All OAuth 2.0 Login Sessions of a Subject
...
*OryClient::SyntaxApi* | [**check_opl_syntax**](docs/SyntaxApi.md#check_opl_syntax) | **POST** /opl/syntax/check | Check the syntax of an OPL file
...
*OryClient::V0alpha2Api* | [**admin_create_self_service_recovery_code**](docs/V0alpha2Api.md#admin_create_self_service_recovery_code) | **POST** /admin/recovery/code | Create a Recovery Code
...
*OryClient::V0alpha2Api* | [**admin_delete_identity_sessions**](docs/V0alpha2Api.md#admin_delete_identity_sessions) | **DELETE** /admin/identities/{id}/sessions | Delete & Invalidate an Identity's Sessions
*OryClient::V0alpha2Api* | [**admin_extend_session**](docs/V0alpha2Api.md#admin_extend_session) | **PATCH** /admin/sessions/{id}/extend | Extend a Session
*OryClient::V0alpha2Api* | [**admin_get_identity**](docs/V0alpha2Api.md#admin_get_identity) | **GET** /admin/identities/{id} | Get an Identity
*OryClient::V0alpha2Api* | [**admin_get_session**](docs/V0alpha2Api.md#admin_get_session) | **GET** /admin/sessions/{id} | This endpoint returns the session object with expandables specified.
*OryClient::V0alpha2Api* | [**admin_list_courier_messages**](docs/V0alpha2Api.md#admin_list_courier_messages) | **GET** /admin/courier/messages | List Messages
...
*OryClient::V0alpha2Api* | [**admin_list_identity_sessions**](docs/V0alpha2Api.md#admin_list_identity_sessions) | **GET** /admin/identities/{id}/sessions | List an Identity's Sessions
*OryClient::V0alpha2Api* | [**admin_list_sessions**](docs/V0alpha2Api.md#admin_list_sessions) | **GET** /admin/sessions | This endpoint returns all sessions that exist.
*OryClient::V0alpha2Api* | [**admin_patch_identity**](docs/V0alpha2Api.md#admin_patch_identity) | **PATCH** /admin/identities/{id} | Patch an Identity
...
*OryClient::V0alpha2Api* | [**list_sessions**](docs/V0alpha2Api.md#list_sessions) | **GET** /sessions | Get Active Sessions
...
*OryClient::V0alpha2Api* | [**revoke_session**](docs/V0alpha2Api.md#revoke_session) | **DELETE** /sessions/{id} | Invalidate a Session
*OryClient::V0alpha2Api* | [**revoke_sessions**](docs/V0alpha2Api.md#revoke_sessions) | **DELETE** /sessions | Invalidate all Other Sessions
...
## Documentation for Models
 ...
 - [OryClient::AdminCreateSelfServiceRecoveryCodeBody](docs/AdminCreateSelfServiceRecoveryCodeBody.md)
 ...
 - [OryClient::GetNamespacesResponse](docs/GetNamespacesResponse.md)
 ...
 - [OryClient::PostCheckOplSyntaxResponse](docs/PostCheckOplSyntaxResponse.md)
 ...
 - [OryClient::SelfServiceRecoveryCode](docs/SelfServiceRecoveryCode.md)
 ...
 - [OryClient::SubmitSelfServiceRecoveryFlowWithCodeMethodBody](docs/SubmitSelfServiceRecoveryFlowWithCodeMethodBody.md)
