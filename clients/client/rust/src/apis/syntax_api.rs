...
pub async fn check_opl_syntax(configuration: &configuration::Configuration, body: &str) -> Result<crate::models::PostCheckOplSyntaxResponse, Error<CheckOplSyntaxError>> {
