...
/// struct for typed errors of method `admin_get_session`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AdminGetSessionError {
    Status400(crate::models::JsonError),
...
/// struct for typed errors of method `admin_list_sessions`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AdminListSessionsError {
    Status400(crate::models::JsonError),
    Status401(crate::models::JsonError),
    Status404(crate::models::JsonError),
    Status500(crate::models::JsonError),
...
pub async fn admin_get_session(configuration: &configuration::Configuration, id: &str, expand: Option<Vec<String>>) -> Result<crate::models::Session, Error<AdminGetSessionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminGetSessionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn admin_list_sessions(configuration: &configuration::Configuration, page_size: Option<i64>, page_token: Option<&str>, active: Option<bool>, expand: Option<Vec<String>>) -> Result<Vec<crate::models::Session>, Error<AdminListSessionsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminListSessionsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn initialize_self_service_login_flow_for_browsers(configuration: &configuration::Configuration, refresh: Option<bool>, aal: Option<&str>, return_to: Option<&str>, cookie: Option<&str>, login_challenge: Option<&str>) -> Result<crate::models::SelfServiceLoginFlow, Error<InitializeSelfServiceLoginFlowForBrowsersError>> {
...
pub async fn initialize_self_service_registration_flow_for_browsers(configuration: &configuration::Configuration, return_to: Option<&str>, login_challenge: Option<&str>) -> Result<crate::models::SelfServiceRegistrationFlow, Error<InitializeSelfServiceRegistrationFlowForBrowsersError>> {
