...
pub struct AdminCreateSelfServiceRecoveryCodeBody {
...
impl AdminCreateSelfServiceRecoveryCodeBody {
    pub fn new(identity_id: String) -> AdminCreateSelfServiceRecoveryCodeBody {
