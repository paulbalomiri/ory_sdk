...
> crate::models::Session admin_get_session(id, expand)
...
> Vec<crate::models::Session> admin_list_sessions(page_size, page_token, active, expand)
...
> crate::models::SelfServiceLoginFlow initialize_self_service_login_flow_for_browsers(refresh, aal, return_to, cookie, login_challenge)
...
> crate::models::SelfServiceRegistrationFlow initialize_self_service_registration_flow_for_browsers(return_to, login_challenge)
