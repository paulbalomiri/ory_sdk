...
defmodule Ory.Kratos.Connection do
  @moduledoc """
  Handle Tesla connections for Ory.Kratos.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, Ory.Kratos.Connection,
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - Ory.Kratos v0.10.1 - elixir"
        )
      )
