...
class _$SelfServiceSettingsFlowSerializer implements PrimitiveSerializer<SelfServiceSettingsFlow> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    SelfServiceSettingsFlow object, {
  ...
  void _deserializeProperties(
    ...
    required SelfServiceSettingsFlowBuilder result,
      ...
      switch (key) {
        ...
        case r'state':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(SelfServiceSettingsFlowState),
          ) as SelfServiceSettingsFlowState;
  ...
  @override
  SelfServiceSettingsFlow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
