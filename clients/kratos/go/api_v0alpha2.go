...
When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
	...
	*/
	...
	@return V0alpha2ApiGetJsonSchemaRequest
	*/
	GetJsonSchema(ctx context.Context, id string) V0alpha2ApiGetJsonSchemaRequest

	// GetJsonSchemaExecute executes the request
	//  @return map[string]interface{}
	GetJsonSchemaExecute(r V0alpha2ApiGetJsonSchemaRequest) (map[string]interface{}, *http.Response, error)
...
type V0alpha2ApiGetJsonSchemaRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	id string
}

func (r V0alpha2ApiGetJsonSchemaRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Get a JSON Schema
 ...
 @return V0alpha2ApiGetJsonSchemaRequest
*/
func (a *V0alpha2ApiService) GetJsonSchema(ctx context.Context, id string) V0alpha2ApiGetJsonSchemaRequest {
	return V0alpha2ApiGetJsonSchemaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *V0alpha2ApiService) GetJsonSchemaExecute(r V0alpha2ApiGetJsonSchemaRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
