...
require 'ory-kratos-client/models/admin_create_identity_import_credentials_oidc'
require 'ory-kratos-client/models/admin_create_identity_import_credentials_oidc_config'
require 'ory-kratos-client/models/admin_create_identity_import_credentials_oidc_provider'
require 'ory-kratos-client/models/admin_create_identity_import_credentials_password'
require 'ory-kratos-client/models/admin_create_identity_import_credentials_password_config'
require 'ory-kratos-client/models/admin_create_self_service_recovery_link_body'
require 'ory-kratos-client/models/admin_identity_import_credentials'
...
require 'ory-kratos-client/models/pagination'
require 'ory-kratos-client/models/recovery_address'
require 'ory-kratos-client/models/revoked_sessions'
...
require 'ory-kratos-client/models/submit_self_service_flow_with_web_authn_registration_method'
...
require 'ory-kratos-client/models/submit_self_service_registration_flow_with_web_authn_method_body'
