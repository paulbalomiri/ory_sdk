...
defmodule Ory.Hydra.Api.Oidc do
  @moduledoc """
  ...
  - `{:ok, Ory.Hydra.Model.OidcConfiguration.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  ...
  def discover_oidc_configuration(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %Ory.Hydra.Model.OidcConfiguration{}},
      {:default, %Ory.Hydra.Model.ErrorOAuth2{}}
    ])
  end
  ...
  - `{:ok, Ory.Hydra.Model.OidcUserInfo.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  ...
  def get_oidc_user_info(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %Ory.Hydra.Model.OidcUserInfo{}},
      {:default, %Ory.Hydra.Model.ErrorOAuth2{}}
    ])
  end
