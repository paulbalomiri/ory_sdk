...
defmodule Ory.Hydra.Model.IntrospectedOAuth2Token do
  @moduledoc """
...
defimpl Poison.Decoder, for: Ory.Hydra.Model.IntrospectedOAuth2Token do
  import Ory.Hydra.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:ext, :map, Ory.Hydra.Model.AnyType, options)
  end
end
